...
const FAT_MIN = 14.8; // 体脂肪量の過去最小値（★★★S34更新 14.8kg）
...
const SEED_DATA = [
  ...
  { date:'2026-07-18', session:'S26', weight:70.8, muscle:51.3, fatMass:16.4, fatPct:23.1, waist:85.5, inbody:75, note:'★★全項目自己ベスト更新の日！体脂肪量16.4kg全期間最小更新（16.9→16.4）・体脂肪率23.1%最良更新（過去最高30.2%→23.1%）・InBody75点で初の最高（74→75）・内臓脂肪レベル6へ初低下（7→6）・体重70.8kg最小。ウエスト85.5維持（85.3付近＝85目前）。右肩下がりで綺麗に減少。7月出張・実家の誘惑ありもコントロール（会食は2200に収め締めのラーメン回避・酒3〜4杯上限、朝昼ほぼプロテイン）。基本メニュー固定（卵・米・鶏胸肉・プロテイン・キムチ・ブロッコリー）で体が異常を起こさない。減量ペース月約1kg（目標1.5kg／今月折返しで-0.5〜1kg進捗）。先生「120点。筋肉ほぼ落ちず、むしろ増えてる可能性＝トレの重量が軽く感じる＝減量成功パターン。アプリ管理で再現性あり」。年内に目標体脂肪-6.8kg完了ペース。GLP-1飲み忘れは胃が空なら昼でもOK（プロテイン液体では満腹の膜が張れず効果薄）。' },
  { date:'2026-07-22', session:'S27', weight:69.7, muscle:51.0, fatMass:15.7, fatPct:22.5, waist:84.5, inbody:75, note:'★★★全項目自己ベスト大幅更新！体脂肪量15.7kg（初の15kg台・16.4→15.7）・体脂肪率22.5%最良更新（23.1→22.5）・体重69.7kg最小（初の69kg台）・ウエスト84.5cm最小（-1.0cm・85.5→84.5）・InBody75点維持。内臓脂肪レベル6を維持（7/18に7→6へ初低下）。わずか4日でこの改善に先生も驚き「筋肉量は変わらず体脂肪だけで削れている」。ベンチ（スミス）46kg×10を体重激減下でも重量維持（相対的な筋力はむしろ向上）。★ショルダープレス10kg自己ベスト更新（前回9kg）。スクワット61kg×12「いつも通り」で筋肉が落ちていないことを確認。減量ペースは月1kg強、TDEE=1500の仮説が最大値/最小値からもほぼ一致。鶏もも→胸肉に変えて浮いた分をお酒・フルーツに充当し1500kcal以内でも会食を楽しむ運用が定着（先生「我慢じゃなく再現性のあるダイエット」）。塩分不足に注意（発汗期は味噌汁等で1日16g目安）。先生「体脂肪率9〜14%が最も筋肉がつきやすいゾーン、今は絞る局面を継続」。ウエストは半年前87〜88cmから劇的に減少、スーツも緩くなりLサイズ→Mサイズへ。' },
  { date:'2026-07-29', session:'S28', weight:70.3, muscle:51.5, fatMass:15.7, fatPct:22.4, waist:84.0, inbody:76, note:'★体脂肪率22.4%全期間最小更新（22.5→22.4）・★InBody76点全期間最高更新（75→76、先生「60点台の人がここまで来た」）・★ウエスト84.0cm更新（-0.5cm・84.5→84.0、7月は6回中4回更新のハイペース）。体重70.3kg・筋肉量51.5kgは水分/筋肉の戻りによる微増だが体脂肪量15.7kgは維持＝脂肪は増えていない証拠（先生「率は下がってる、体脂肪は体重が増えても増えてない」）。健康診断がモチベーションになりこの1ヶ月でガクンと改善、管理開始から3ヶ月弱・2ヶ月目から数値変化。出張（札幌・大阪・兵庫）が続く多忙な週でもコントロールでき、会食で飲酒しても1500kcal以内に収め翌日調整するルールが定着（先生「メンタル的に無理していない、計算通りに落ちてる＝来月も再現性あり」）。ラットプル45kg×12（3set目40kgに落として筋持久意識）・ロープーリー40kg×15×2・インクライン(スミス)41kg×10×2（3set目31kgドロップ）・ケーブルフライ15kg×15×2・サイドレイズ4kg×15×2・スクワット61kg×12・モンスターウォーク・下腹Vシット腹筋15回×3。プロテインに塩ひとつまみで腹持ちUPの工夫も。' },
  { date:'2026-08-01', session:'S29', weight:70.1, muscle:51.6, fatMass:15.4, fatPct:22.0, waist:84.5, inbody:76, note:'★体脂肪量15.4kg全期間最小値更新（15.7→15.4）・★体脂肪率22%全期間最小値更新（22.4→22.0、20%未満の"標準"まであと一歩）。InBody76点はS28と同水準を維持。体重70.1kg・筋肉量51.6kgはやや戻りも脂肪はしっかり最小更新＝良い兆候。ウエスト84.5cm（S28の84.0から+0.5、前日会食の胃内容物による一時的な戻りで脂肪増ではない）。1月のピーク（体重最大・体脂肪率30%超の時期）から通算約9.5kg減、自宅体重で初めて79kg切り。先生「筋肉量は落ちていない、すごい脂肪だけで落ちてる」＝リコンプ（筋肉維持しつつ脂肪だけ減）が順調に進行。半月で体脂肪率1.5〜2%落ちるカクンとした変化を先生も驚き、要因は会食日も「食べていい」と割り切りつつ酒量・カロリー(2000何百kcal)をコントロールできる術を掴んだこと。' },
  { date:'2026-08-08', session:'S30', weight:72.7, muscle:53.7, fatMass:15.1, fatPct:20.9, waist:84.0, inbody:79, note:'★InBody79点全期間最高更新（76→79、+3点）・★体脂肪量15.1kg全期間最小値更新（15.4→15.1）・★体脂肪率20.9%全期間最小値更新（22.0→20.9、先生「いよいよ19%が見えてきた」）。体重72.7kg・筋肉量53.7kgは大幅増に見えるが、体内水分量41.9L（前回40.2Lから+1.7L）と会食後の塩分・水分戻り＋リフィード（栄養を戻すフェーズ）による一時的なもので、脂肪は増えていない（先生「率は下がってる、水分が多く含まれてるだけ」）。基礎代謝1400→1600kcalに急上昇。ウエスト84.0cm、S28の全期間最小値に並ぶ（S29の84.5から-0.5、先生「やっぱ体脂肪落ちてるんでしょうね」）。ゴールデンウィーク時67点からの比較で体脂肪-1.4〜1.3kg・胴体中心に-3kg減／筋肉+0.9〜1.8kgと全身まんべんなく変化（部分痩せではない証拠）。管理開始（2月始動・アプリ導入5月・トレーニング開始7月）から半年弱で積み上げ効果が加速。' },
  { date:'2026-08-15', session:'S31', weight:70.9, muscle:51.9, fatMass:15.8, fatPct:22.2, waist:84.5, inbody:76, note:'InBody76点（前回S30の79点から-3点）。体重70.9kg・筋肉量51.9kg・体脂肪量15.8kg・体脂肪率22.2%。先生：S30が急激に栄養が入ってむくんでいた状態からまだ完全には戻りきれておらず、加えて前日ひさびさに昼食でライスを普通に食べたことも一因。ただし体脂肪がこれほど短期間で増えることは考えにくく、実質的な体脂肪量は15.4kg前後・筋肉量は50kg台前半とみるのが妥当という見立て（先生「体脂肪は増えてないです」）。ウエスト84.5cm（S30の全期間最小値84.0から+0.5）。誤差の範囲の変動として、ありのままデータの1点として記録。' },
  { date:'2026-08-22', session:'S32', weight:71.1, muscle:52.2, fatMass:15.7, fatPct:22.1, waist:85.5, inbody:77, note:'InBody77点（前回S31の76点から+1点、体脂肪量15.7kg・体脂肪率22.1%はほぼ横ばい）。前日に焼肉を食べた影響で今週の数値は先週とトントンに見えるが、先生「食べていなければもう少し体重が落ちていたはず、ベースは着実に低下している」。体脂肪1kg増に必要な7000kcal理論から逆算すると、前日のオーバーカロリー分で脂肪化しうるのは数百グラム程度に過ぎず気にする必要なしとの見立て。ウエスト85.5cm、全期間最小値84.0cmから+1.5cm（前日の食事量による胃の張りが主因、実家で家族と食事し外食・会食ではなく素の食欲で食べた1日）。' },
  { date:'2026-08-26', session:'S33', weight:69.7, muscle:51.7, fatMass:14.9, fatPct:21.3, waist:null, inbody:77, note:'★体脂肪量14.9kg全期間最小値更新（15.1→14.9）。体重69.7kg・筋肉量51.7kg・体脂肪率21.3%、InBody77点は前回と同水準。前回S32の71.1kgは出張・実家での食事による一時的な増加だったが、今回は出張なしの「ダイエット通常運転」の状態。過去に同じ69.7kgだった時期と比べても明らかに筋肉量が高く体脂肪率は約1%低い＝同じ体重でも中身が確実に改善している証拠。ストレス（多忙な仕事）でむしろカロリー消費が進んでいる可能性も。理論値（体脂肪7000kcal/kg換算）と実測の減少ペースがほぼ一致し「誤差ではなく本当に落ちている」と先生も太鼓判。ウエストは今回未計測。' },
  { date:'2026-08-29', session:'S34', weight:71.1, muscle:53.1, fatMass:14.8, fatPct:20.8, waist:85.0, inbody:79, note:'★体脂肪量14.8kg全期間最小値更新（14.9→14.8）。体脂肪率20.8%も改善、InBody79点（前回77点から+2点）。体重71.1kg・筋肉量53.1kgは増加に見えるが、出張先での会食・炭酸割りハイボールの影響で体内水分量が普段より多く（前回の同体重時より+0.6L）、実質的な脂肪増ではないとの見立て（先生「筋肉貯金と脂肪返済」の関係で、会食後は一旦筋肉に栄養を戻す＝リバウンドして見えるが脂肪化はしない仕組み）。前日ほぼ炭水化物を摂らず、味噌汁（1日2杯、朝晩）の塩分過多＋ハイボールの炭酸で胃腸が荒れ、軽い下痢気味に。ウエスト85.0cm（前回85.5cmから-0.5）。InBodyスコアの仕組み：脂肪は標準100から増減どちらでも減点、筋肉は既に標準超のため増えるほど減点＝現状は「脂肪を落として標準に近づける」のが最も加点効率が良いフェーズ（あと4〜5点で標準到達の見立て）。' },
  { date:'2026-09-05', session:'S35', weight:69.4, muscle:51.3, fatMass:15.0, fatPct:21.6, waist:84.0, inbody:76, note:'体重69.4kg、最近の実質的な最小値（自宅計測では68kg台も）。筋肉量51.3kg・体脂肪量15.0kg・体脂肪率21.6%、InBody76点（前回79点から-3点）。先生：前回は栄養・水分がみちみちに満ちた状態でInBody点数は高かったが体重は重め（71kg・ウエスト85cm程度）、今回はその水分が約1.5L抜けて「スカスカ」の分、点数は下がったが体重はしっかり落ちている＝ダイエット的にはこちらの方が本質的に良い状態との説明。ウエスト84.0cm、全期間最小値にタイ。当初の目標体重68kgは実質クリア。1cm≒1kgの経験則で見ると、ピークから体重-4〜5kg・ウエスト-10cmとハイペースで進行中（1kgあたり約2cm換算）。今後さらにウエスト-4〜5cm・体重63〜65kg程度まで絞れたら、そこから筋肉を増やす「リーンバルク」フェーズへ移行予定。この1週間ほど涼しさで体が冷えて体調不良気味（鼻声・疲労）、栄養・エネルギー不足も一因（先生「毎朝の体温が平熱-0.2℃なら不調のサイン」）。' },
  { date:'2026-09-12', session:'S36', weight:69.6, muscle:51.2, fatMass:15.3, fatPct:22.0, waist:84.0, inbody:76, note:'体重69.6kg・筋肉量51.2kg・体脂肪量15.3kg・体脂肪率22.0%、InBody76点（前回と同水準）。前日は熟成肉レストラン＋懇親会でワイン6〜7杯とがっつり飲食したが、体脂肪の上振れは内臓の一時的な炎症によるもので、実質的な体脂肪量は14.8kg程度（前回並み）とみるのが妥当との見立て（筋肉量も同様に一時的に低く出ているだけ）。体重は60kg台で安定し始めた印象、当初目標の68kgに向けさらに一段落ちる局面が近いとの見立て。ウエスト84.0cm、全期間最小値を継続キープ（「84cmがデフォルトになってきている」）。先生：「一気に落とすと筋肉も一緒に落ちる、停滞を楽しみながら探るのが正解」の方針を継続。' },
];
...
const SEED_TRAINING = [
  ...
  { date:'2026-07-18', session:'S26', waist:85.5, exercises:[
    {name:'ラットプルダウン',weight:45,reps:12,sets:2},
    {name:'ロープーリー',weight:40,reps:15,sets:2},
    {name:'インクラインベンチ（スミス）',weight:41,reps:10,sets:2},
    {name:'サイドレイズ',weight:4,reps:15,sets:2},
    {name:'スクワット',weight:61,reps:12,sets:1},
    {name:'腹筋（下腹）',weight:null,reps:10,sets:3}
  ], comment:'★★全項目自己ベスト更新日（体脂肪量16.4kg・体脂肪率23.1%・InBody75点・内臓脂肪6・体重70.8kg）。ラットプル45kg×12×2で初めて2セットとも胸につけて（フル可動）完遂＋3set目40kg×15。ロープーリー40kg×15（肩甲骨を寄せる意識）。インクライン（スミス）41kg×10×2自力成功（25→31→41ウォームアップ、3set目31kg×10でフォーム重視）。サイドレイズ4kg×15×2。スクワット61kg×12いつも通り。下腹腹筋で締め。全種目「今日は軽い／スムーズ」＝可動域も広がり出力低下なし→先生「筋肉が減っていない、むしろ増えてる可能性。減量なのに重量が軽く感じるのは大成功パターン」。脂肪が落ちて筋の境目・関節可動域がクリアに。重量更新より絞りが目的、フォーム精度フェーズ継続。' },
  { date:'2026-07-22', session:'S27', waist:84.5, exercises:[
    {name:'ロープーリー',weight:null,reps:15,sets:3},
    {name:'ラットプルダウン',weight:40,reps:12,sets:2},
    {name:'ベンチプレス（スミス）',weight:46,reps:10,sets:2},
    {name:'ショルダープレス',weight:10,reps:10,sets:null},
    {name:'スクワット',weight:61,reps:12,sets:1},
    {name:'モンスターウォーク',weight:null,reps:null,sets:3},
    {name:'ハンズアップクランチ',weight:null,reps:15,sets:2}
  ], comment:'★★★全項目自己ベスト大幅更新（体脂肪量15.7kg初の15kg台・体脂肪率22.5%・体重69.7kg初の69kg台・ウエスト84.5cm-1.0cm・InBody75点維持）。ロープーリー15回×3（重量据え置き）。ラットプル40kg×12×2。ベンチ（スミス）46kg×10×2は26→36ウォームアップ経由、体重激減下でも重量維持し最後31kgに落として収縮ドロップ×10。★ショルダープレス10kg自己ベスト更新（前回9kg、わずか+1kgでも体感差大）。スクワット61kg×12「いつも通り」で筋肉維持を再確認。モンスターウォーク→ハンズアップクランチ（上バージョン）で締め。先生「筋肉量は変わらず体脂肪だけで削れている、相対的な筋力はむしろ向上」。内臓脂肪レベル6維持。減量ペース月1kg強・TDEE=1500の仮説が最大値/最小値からもほぼ一致。鶏もも→胸肉で浮いた分をお酒・フルーツに充当し1500kcal以内で会食も楽しむ運用が定着。塩分不足に注意（発汗期は味噌汁等で1日16g目安）。スーツが緩くなりLサイズ→Mサイズへ。' },
  { date:'2026-07-29', session:'S28', waist:84.0, exercises:[
    {name:'ラットプルダウン',weight:45,reps:12,sets:2},
    {name:'ロープーリー',weight:40,reps:15,sets:2},
    {name:'インクラインベンチ（スミス）',weight:41,reps:10,sets:2},
    {name:'ケーブルフライ/チェストフライ',weight:15,reps:15,sets:2},
    ...
    {name:'スクワット',weight:61,reps:12,sets:1},
    {name:'モンスターウォーク',weight:null,reps:null,sets:3},
    {name:'腹筋（下腹）',weight:null,reps:15,sets:3}
  ], comment:'★体脂肪率22.4%全期間最小更新（22.5→22.4）・★InBody76点全期間最高更新（75→76）・★ウエスト84.0cm更新（-0.5cm、7月は6回中4回更新のハイペース）。体重70.3kg・筋肉量51.5kgは水分/筋肉の戻りによる微増だが体脂肪量15.7kgは維持＝脂肪は増えていない証拠。ラットプル45kg×12×2＋3set目40kgに落として筋持久意識。ロープーリー40kg×15×2。インクライン（スミス）41kg×10×2＋3set目31kgドロップ（1週間ぶりに重量への手応え実感）。ケーブルフライ15kg×15×2（脂肪が落ちて対象筋への意識がしやすくなったと実感）。サイドレイズ4kg×15×2。スクワット61kg×12いつも通り。モンスターウォーク→下腹Vシット腹筋15回×3で締め。健康診断がモチベーションになりこの1ヶ月でガクンと改善、管理開始から3ヶ月弱・2ヶ月目から数値変化が出始めた。出張（札幌・大阪・兵庫）が続く多忙な週でもコントロールでき、会食で飲酒しても1500kcal以内に収め翌日調整するルールが定着。先生「メンタル的に無理していない、計算通りに落ちてる＝来月も再現性あり」。プロテインに塩ひとつまみで腹持ちUPの工夫も。' },
  { date:'2026-08-01', session:'S29', waist:84.5, exercises:[
    {name:'ロープーリー',weight:45,reps:15,sets:3},
    {name:'ラットプルダウン',weight:40,reps:12,sets:2},
    {name:'ベンチプレス（スミス）',weight:46,reps:10,sets:2},
    {name:'インクラインダンベルフライ',weight:9,reps:10,sets:2},
    {name:'スクワット',weight:61,reps:12,sets:1},
    {name:'モンスターウォーク',weight:null,reps:null,sets:3},
    {name:'ハンズアップクランチ',weight:null,reps:15,sets:3}
  ], comment:'★体脂肪量15.4kg全期間最小値更新（15.7→15.4）・★体脂肪率22%全期間最小値更新（22.4→22.0）。InBody76点はS28と同水準維持。ロープーリー45kg×15×3（前回40kgから重量アップ）。ラットプル40kg×12×2、「ちょっと重い」と体感するも完遂。ベンチ（スミス）46kg×10×2は20→26→36ウォームアップ経由、最後31kgドロップ×10。インクラインダンベルフライは重量調整しつつ10回で完遂。スクワット61kg×12いつも通り「全部効いた、可動域が大事」。モンスターウォーク→ハンズアップクランチ（手を上げるバージョン）15回×3で締め。ウエスト84.5cm（S28の84.0から+0.5、前日会食の胃内容物による一時的な戻り）。1月ピーク（体重最大・体脂肪率30%超）から通算約9.5kg減、自宅体重で初めて79kg切り。先生「筋肉量は落ちていない、脂肪だけで落ちてる」＝リコンプ順調。8/11の大会（先生自身）に向け先生も減量追い込み中、来週土曜から炭水化物を戻すカーボアップの話も。' },
  { date:'2026-08-08', session:'S30', waist:84.0, exercises:[
    {name:'ラットプルダウン',weight:45,reps:12,sets:2},
    {name:'インクラインベンチ（スミス）',weight:41,reps:10,sets:2},
    {name:'Tバーロウ',weight:26,reps:10,sets:2},
    {name:'サイドレイズ',weight:4,reps:15,sets:2},
    {name:'スクワット',weight:61,reps:12,sets:1},
    {name:'モンスターウォーク',weight:null,reps:null,sets:3}
  ], comment:'★InBody79点全期間最高更新（76→79）・★体脂肪量15.1kg全期間最小値更新（15.4→15.1）・★体脂肪率20.9%全期間最小値更新（22.0→20.9、先生「いよいよ19%が見えてきた」）。体重72.7kg・筋肉量53.7kgは大幅増に見えるが体内水分41.9L（前回40.2Lから+1.7L）と会食後の塩分・水分戻り＋リフィードによる一時的なもので脂肪は増えていない。基礎代謝1400→1600kcalに急上昇。ラットプル45kg×12×2（3set目は軽量に落として10回）。インクライン（スミス）41kg×10×2キープ。新種目Tバーロウ導入（音声から重量の細部は聞き取り不明瞭、最終セット26kg×10で記録・要次回確認）。横に上げるやつ（サイドレイズ）15回×2、重量は前回同様4kgと推定。スクワット61kg×12いつも通り。モンスターウォークで締め。ウエスト84.0cm、S28の全期間最小値に並ぶ（S29の84.5から-0.5）。ゴールデンウィーク時（67点）との比較で体脂肪は胴体中心に-3kg・筋肉は+0.9〜1.8kgと全身まんべんなく変化＝部分痩せでないことを裏付け。' },
  { date:'2026-08-15', session:'S31', waist:84.5, exercises:[
    {name:'ロープーリー',weight:45,reps:15,sets:3},
    {name:'ラットプルダウン',weight:40,reps:12,sets:2},
    {name:'ベンチプレス（スミス）',weight:46,reps:10,sets:2},
    {name:'インクラインダンベルフライ',weight:9,reps:12,sets:2},
    {name:'ショルダープレス',weight:10,reps:12,sets:2},
    {name:'インクラインベンチ（スミス）',weight:41,reps:10,sets:1},
    {name:'スクワット',weight:61,reps:12,sets:1},
    {name:'ハンズアップクランチ',weight:null,reps:15,sets:3}
  ], comment:'InBody76点（前回S30の79点から-3点、S30時点の急激な栄養補給によるむくみが残っていたことと前日のライス摂取が主因、体脂肪の実質増加ではない）。ロープーリー45kg×15×3ストレートセット。ラットプルダウン40kg×12×2（座面・足位置を試行錯誤し通常ポジションに帰着）。ベンチプレス（スミス）46kg×10×2＋最後31kgドロップ×10、「昔はこの重さでも手を引いてたのに成長を感じます」。インクラインダンベルフライ12回×2（重量は前回同様9kg程度と推定）。ショルダープレス12回×2（重量は前回同様10kg程度と推定）。インクラインベンチ（スミス）41kgを1週間ぶりに実施。スクワット61kg×12いつも通り。ハンズアップクランチ15回×3で締め（今回はモンスターウォークなし）。会話メモ：食後の血糖値スパイク→インスリンによる腹部脂肪蓄積を防ぐ「食後スクワット10回」ルーティンの提案（毎食後、炭水化物摂取時のみ）。オルニチン系サプリで体調が悪化する自覚があり摂取中断を検討中。' },
  { date:'2026-08-22', session:'S32', waist:85.5, exercises:[
    {name:'ロープーリー',weight:45,reps:12,sets:2},
    {name:'ラットプルダウン',weight:40,reps:15,sets:2},
    {name:'インクラインベンチ（スミス）',weight:41,reps:10,sets:2},
    {name:'ケーブルデックフライ',weight:15,reps:15,sets:2},
    {name:'サイドレイズ',weight:4,reps:15,sets:2},
    {name:'スクワット',weight:61,reps:12,sets:1},
    {name:'モンスターウォーク',weight:null,reps:null,sets:3},
    {name:'ハンズアップクランチ',weight:null,reps:15,sets:3}
  ], comment:'InBody77点（前回76点から+1点）。前日の焼肉によるオーバーカロリーで今週の数値は先週とほぼ横ばいに見えるが、先生「ベースはもう少し落ちてるはず」。ロープーリー45kg×12×2。ラットプルダウン40kg×15×2（今回は回数多めで実施）。インクラインベンチ（スミス）41kg×10×2＋最後26kgドロップ×10（20kgウォームアップ経由）、胸を寄せる意識・腕の角度（脇を軽く締める中間ポジション）のフォーム指導が中心に。ケーブルデックフライ15回×2（重量は前回同様15kg程度と推定）、「寄せる」動きが押す動作より単関節で効くと実感。サイドレイズ4kg×15×2、反動を使わないフォーム重視で実施（先生も同様の減重フォーム重視の経験談を共有）。スクワット61kg×12（41kgウォームアップ経由）。モンスターウォーク×3。下っ腹（ハンズアップクランチ）15回×3で「完全燃焼」して終了。ウエスト85.5cm、全期間最小値84.0cmから+1.5cm（前日の食事量による胃の張り）。' },
  { date:'2026-08-26', session:'S33', waist:null, exercises:[
    {name:'ロープーリー',weight:45,reps:12,sets:3},
    {name:'ラットプルダウン',weight:40,reps:12,sets:2},
    {name:'ベンチプレス（スミス）',weight:46,reps:10,sets:2},
    {name:'ショルダープレス',weight:10,reps:15,sets:2},
    {name:'インクラインダンベルフライ',weight:9,reps:12,sets:2},
    {name:'スクワット',weight:61,reps:12,sets:1},
    {name:'モンスターウォーク',weight:null,reps:null,sets:3},
    {name:'ハンズアップクランチ',weight:null,reps:15,sets:3}
  ], comment:'★体脂肪量14.9kg全期間最小値更新（15.1→14.9）、体脂肪率21.3%・InBody77点は前回と同水準。前回S32(71.1kg)は出張・実家での食事による一時的な増加で、今回は通常運転の69.7kg。ロープーリー（重量・回数の細部は音声不明瞭、前回同様45kg程度と推定）。ラットプルダウン40kg×12×2、反動を封じたフォームで実施（声を出さないと持たないほどの負荷、いつもは反動・多関節化でパワーを出していたと判明）。ベンチプレス（スミス）46kg×10×2＋31kgドロップ×10（20→30kgウォームアップ経由）、押した時に胸周りの脂肪が薄くなっているのを実感。ショルダープレス10kg×15回×2（回数を12→15に増加）。インクラインダンベルフライ（重量は前回同様9kg程度と推定）12回×2。スクワット61kg×12いつも通り。モンスターウォーク×3。ハンズアップクランチ15回×3で締め、「今日も再現性のある結果」と先生。会話メモ：エネルギー枯渇時は「脂肪を燃料に変えているイメージ」で乗り切るメンタルトレーニング法を先生が実演。先生自身も大会後+4kg維持しつつ暴食生活で汗だくの日々とのこと。' },
  { date:'2026-08-29', session:'S34', waist:85.0, exercises:[
    {name:'ラットプルダウン',weight:45,reps:12,sets:2},
    {name:'インクラインベンチ（スミス）',weight:41,reps:10,sets:1},
    {name:'スクワット',weight:61,reps:12,sets:1},
    {name:'ケーブルデックフライ',weight:15,reps:15,sets:2},
    ...
    {name:'モンスターウォーク',weight:null,reps:null,sets:3},
    {name:'ハンズアップクランチ',weight:null,reps:15,sets:3}
  ], comment:'★体脂肪量14.8kg全期間最小値更新（14.9→14.8）、体脂肪率20.8%・InBody79点（前回77点から+2点）も改善。体重・筋肉量の増加は出張先での会食・炭酸割りハイボールによる水分/塩分の一時的な増加で、脂肪の実質増ではない（先生「筋肉貯金と脂肪返済」の関係で説明）。前日炭水化物をほぼ摂らずお腹を下し気味で、終始いつもよりパワーが出にくい状態（味噌汁の塩分でなんとか踏ん張れた、と先生）。ラットプルダウン45kg×12×2（3set目は40kgに落として15回）。インクラインベンチ（スミス）41kg×10×1（今日は1セットのみ、押し切るパワーが出にくく調整）。スクワット61kg×12（41kgウォームアップ経由）。ケーブルデックフライ15回×2。サイドレイズ4kg×15×2。モンスターウォーク×3。ハンズアップクランチ15回×3で8月を締めくくり。ウエスト85.0cm（前回85.5cmから-0.5）。InBodyスコア解説：脂肪は標準100から増減どちらでも減点、筋肉は既に標準超のため増えるほど減点＝今は脂肪を落として標準に近づけるのが最も加点効率の良いフェーズ（あと4〜5点で標準84点の見立て）。' },
  { date:'2026-09-05', session:'S35', waist:84.0, exercises:[
    {name:'ロープーリー',weight:45,reps:15,sets:2},
    {name:'ラットプルダウン',weight:40,reps:12,sets:1},
    {name:'インクラインダンベルフライ',weight:8,reps:10,sets:1},
    {name:'ショルダープレス',weight:10,reps:10,sets:1},
    {name:'スクワット',weight:61,reps:12,sets:1},
    {name:'ハンズアップクランチ',weight:null,reps:15,sets:3}
  ], comment:'体調不良気味（冷え・鼻声・疲労）のため、先生の判断で全種目を通常より軽め・回数少なめに調整（今日はモンスターウォーク省略）。「今日はすでにマイナスからのスタートなので、通常通りの強度でやると回復不能になり風邪が悪化する」という理論で強度を意図的に5〜6割に抑制。ロープーリーは意外にも好調（体調の割によく上がった）。ラットプルダウンは逆に本調子が出ず、予定の15回に届かず12回で終了＝先生いわく「ラットプルは体調のバロメーター」。インクラインダンベルフライは重量を9→8kgに落として10回×1セット。フックグリップ（新種目、重量段階的に調整）も少し実施。ショルダープレスは重量そのまま・回数を12→10に減らして1セットのみ。スクワットは深くしゃがめており（先生手本の深さまで到達）フォームは良好。ハンズアップクランチ15回×3で締め。ウエスト84.0cm実測、全期間最小値にタイ。会食前のカロリー戦略：エネルギー不足分を補うためおにぎり2個分の炭水化物を先に追加する提案あり（アルコール中心の会食はカロリーはあっても栄養価が低いため）。' },
  { date:'2026-09-12', session:'S36', waist:84.0, exercises:[
    {name:'ラットプルダウン',weight:45,reps:12,sets:2},
    {name:'ロープーリー',weight:40,reps:15,sets:2},
    {name:'インクラインベンチ（スミス）',weight:41,reps:10,sets:2},
    {name:'レッグカール',weight:15,reps:15,sets:1},
    {name:'サイドレイズ',weight:4,reps:15,sets:1},
    {name:'カーフレイズ',weight:40,reps:12,sets:1},
    {name:'モンスターウォーク',weight:null,reps:null,sets:3},
    {name:'ハンズアップクランチ',weight:null,reps:15,sets:3}
  ], comment:'久々にフルメニューで実施（「リハビリ日和」と先生）。前日の肉・米中心の食事＋懇親会でエネルギー十分、パワーが出て絶好調のセッションに。ラットプルダウン45kg×12×2（3set目は40kgに落として12回、クオリティ重視）。ロープーリー40kg×15×2、肩甲骨を寄せる意識でしっかりストレッチ。インクラインベンチ（スミス）41kg×10×2、今日は足の力の伝わりが良く好調。レッグカール15kg×15（新種目・内側に締める意識）。サイドレイズ4kg×15。カーフレイズ40kg×12（久々に実施）。モンスターウォーク×3。ハンズアップクランチ15回×3で締め、腰回り・膝周りの脂肪が落ちて可動域が広がってきた実感あり。ウエスト84.0cm、全期間最小値を継続キープ。会話メモ：1500kcalの継続はきついので、たまに多く食べる日を作ることが停滞・筋力低下の予防に重要（先生も過去1000kcalまで削って停滞した失敗談）。将来的な増量期の話も（プラス500kcal程度から開始想定）。' },
];
...
const SEED_WAIST = [
  ...
  { date:'2026-07-18', waist:85.5 },
  { date:'2026-07-22', waist:84.5 },
  { date:'2026-07-29', waist:84.0 },
  { date:'2026-08-01', waist:84.5 },
  { date:'2026-08-08', waist:84.0 },
  { date:'2026-08-15', waist:84.5 },
  { date:'2026-08-22', waist:85.5 },
  { date:'2026-08-29', waist:85.0 },
  { date:'2026-09-05', waist:84.0 },
  { date:'2026-09-12', waist:84.0 },
];
function loadWaist() {
  let stored = null;
  try {
    ...
    new Chart(bcCtx.getContext('2d'), {
      ...
      options: {
        ...
        scales: {
          ...
          y1: { type: 'linear', position: 'right', min: 15, max: 33, grid: { drawOnChartArea: false }, title: { display: true, text: '体脂肪率 %', font: { size: 9 } }, ticks: { font: { size: 8 } } },
